...
```
npm create cloudflare@latest -- --template=cloudflare/templates/noisy-surf-fe56
```

## Preview Deployment

A live public deployment of this template is available at [https://noisy-surf-fe56.templates.workers.dev](https://noisy-surf-fe56.templates.workers.dev)
